// node_modules/vitessce/dist/pako.esm-D68R8YXe.js
function U(t) {
  let i = t.length;
  for (; --i >= 0; )
    t[i] = 0;
...
var ze = 30;
var ft = 512;
var ot = new Array((at + 2) * 2);
U(ot);
var lt = new Array(ze * 2);
U(lt);
var st = new Array(ft);
U(st);
var rt = new Array(it - tt + 1);
U(rt);
var ct = new Array($e);
U(ct);
var dt = new Array(ze);
...
var _t = (t, i) => Object.prototype.hasOwnProperty.call(t, i);
var bt = function(t) {
...
var Ht = 15;
var Bt = Ht;
var Me = (t) => (t >>> 24 & 255) + (t >>> 8 & 65280) + ((t & 65280) << 8) + ((t & 255) << 24);
function Ft() {
...
var Kt = (t) => {
  if (Ue) {
    ...
    for (L(Ge, t.lens, 0, 288, q, 0, t.work, { bits: 9 }), i = 0; i < 32; )
      t.lens[i++] = 5;
    L(Ke, t.lens, 0, 32, ee, 0, t.work, { bits: 5 }), Ue = false;
  }
    ...
    for (; ; )
      switch (e.mode) {
        case Xe:
          ...
          if (e.flags = 0, e.head && (e.head.done = false), !(e.wrap & 1) || /* check if zlib header allowed */
          (((a & 255) << 8) + (a >> 8)) % 31) {
        ...
        case Ee:
          ...
          e.head && (e.head.hcrc = e.flags >> 9 & 1, e.head.done = true), t.adler = e.check = 0, e.mode = I;
          break;
        case pe:
          for (; f < 32; ) {
            if (l === 0)
...
var Xt = (t, i) => {
  if (!t || !t.state)
    return m;
  const e = t.state;
  return (e.wrap & 2) === 0 ? m : (e.head = i, i.done = false, N);
};
var Yt = (t, i) => {
  const e = i.length;
  let o, r, n;
...
var ii = Xt;
var ni = Yt;
var ai = "pako inflate (from Nodeca project)";
var O = {
  inflateReset: Wt,
  inflateReset2: Jt,
  inflateResetKeep: Qt,
...
function Y(t) {
  ...
  i.raw && i.windowBits >= 0 && i.windowBits < 16 && (i.windowBits = -i.windowBits, i.windowBits === 0 && (i.windowBits = -15)), i.windowBits >= 0 && i.windowBits < 16 && !(t && t.windowBits) && (i.windowBits += 32), i.windowBits > 15 && i.windowBits < 48 && (i.windowBits & 15) === 0 && (i.windowBits |= 15), this.err = 0, this.msg = "", this.ended = false, this.chunks = [], this.strm = new At(), this.strm.avail_out = 0;
...
Y.prototype.push = function(t, i) {
  ...
  for (i === ~~i ? d = i : d = i === true ? si : li, et.call(t) === "[object ArrayBuffer]" ? e.input = new Uint8Array(t) : e.input = t, e.next_in = 0, e.avail_in = e.input.length; ; ) {
    ...
    if (!(n === z && l === 0)) {
      if (n === te)
        return n = O.inflateEnd(this.strm), this.onEnd(n), this.ended = true, true;
...
//# sourceMappingURL=chunk-EGYU6PWU.js.map
