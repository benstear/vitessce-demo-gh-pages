...
// node_modules/vitessce/dist/zstd-DoGJTjDa.js
var aI = Object.defineProperty;
var NI = (q, h, C2) => h in q ? aI(q, h, { enumerable: true, configurable: true, writable: true, value: C2 }) : q[h] = C2;
var m = (q, h, C2) => NI(q, typeof h != "symbol" ? h + "" : h, C2);
var _a;
var UI = (typeof document < "u" && ((_a = document.currentScript) == null ? void 0 : _a.src), function(q = {}) {
  var h, C2 = q, L, Y, t = new Promise((A, I) => {
    L = A, Y = I;
  }), oA = Object.assign({}, C2), Z = C2.printErr || console.error.bind(console);
  Object.assign(C2, oA), oA = null;
  var p;
  C2.wasmBinary && (p = C2.wasmBinary);
  var V, GA = false, e, R, n, b, f, a, yA, FA;
  function hA() {
    var A = V.buffer;
    C2.HEAP8 = e = new Int8Array(A), C2.HEAP16 = n = new Int16Array(A), C2.HEAPU8 = R = new Uint8Array(A), C2.HEAPU16 = b = new Uint16Array(A), C2.HEAP32 = f = new Int32Array(A), C2.HEAPU32 = a = new Uint32Array(A), C2.HEAPF32 = yA = new Float32Array(A), C2.HEAPF64 = FA = new Float64Array(A);
  }
  var wA = [], RA = [], SA = [], aA = false;
  function VA() {
    var A = C2.preRun.shift();
    wA.unshift(A);
  }
  var d = 0, P = null;
  function NA(A) {
    var _a2;
    throw (_a2 = C2.onAbort) == null ? void 0 : _a2.call(C2, A), A = "Aborted(" + A + ")", Z(A), GA = true, A += ". Build with -sASSERTIONS for more info.", aA && rA(), A = new WebAssembly.RuntimeError(A), Y(A), A;
  }
  ...
  var AI = (A, I) => {
    if (C2[A].D === void 0) {
      var g = C2[A];
      C2[A] = function(...B) {
        if (!C2[A].D.hasOwnProperty(B.length))
          throw new S(`Function '${I}' called with an invalid number of arguments (${B.length}) - expects one of (${C2[A].D})!`);
        return C2[A].D[B.length].apply(this, B);
      }, C2[A].D = [], C2[A].D[g.G] = g;
    }
  }, II = (A, I, g) => {
    if (C2.hasOwnProperty(A)) {
      if (g === void 0 || C2[A].D !== void 0 && C2[A].D[g] !== void 0)
        throw new S(`Cannot register public name '${A}' twice`);
      if (AI(A, A), C2.hasOwnProperty(g))
        throw new S(`Cannot register multiple overloads of a function with the same number of arguments (${g})!`);
      C2[A].D[g] = I;
    } else
      C2[A] = I, g !== void 0 && (C2[A].J = g);
  }, gI = (A, I) => {
    for (var g = [], B = 0; B < A; B++)
      g.push(a[I + 4 * B >> 2]);
    return g;
  }, IA, BI = (A, I, g = []) => (A.includes("j") ? (A = A.replace(/p/g, "i"), I = (0, C2["dynCall_" + A])(I, ...g)) : I = IA.get(I)(...g), I), QI = (A, I) => (...g) => BI(A, I, g), CI = (A, I) => {
    A = J(A);
    ...
    function g(i) {
      Q[i] || r[i] || (X[i] ? X[i].forEach(g) : (B.push(i), Q[i] = true));
    }
    var B = [], Q = {};
  ...
  C2.incrementExceptionRefcount = (A) => {
    A = BA(A), xA(A);
  }, C2.decrementExceptionRefcount = (A) => {
    A = BA(A), TA(A);
  }, C2.getExceptionMessage = (A) => {
    var I = BA(A);
    A = WA();
    var g = CA(4), B = CA(4);
  ...
  YA = qA, S = C2.BindingError = class extends Error {
    constructor(A) {
      super(A), this.name = "BindingError";
    }
  }, u = C2.InternalError = class extends Error {
    constructor(A) {
      super(A), this.name = "InternalError";
    }
  }, H.push(0, 1, void 0, 1, null, 1, true, 1, false, 1), C2.count_emval_handles = () => H.length / 2 - 5 - $.length, KA = C2.UnboundTypeError = ((A, I) => {
  ...
  var RI = { l: () => {
    ...
    A = J(A), A = iI(A), Q = CI(B, Q), II(A, function() {
      ...
      (E) => {
        ...
        var c = E[1] !== null && false, O = LA(E), fA = E[0].name !== "void";
...
`);
        let [OA, SI] = [EA, k + `}
`];
        if (OA.push(SI), E = _A(OA)(...s), y = AA(y, E), E = I - 1, !C2.hasOwnProperty(G))
          throw new u("Replacing nonexistent public symbol");
        return C2[G].D !== void 0 && E !== void 0 ? C2[G].D[E] = y : (C2[G] = y, C2[G].G = E), [];
      }
    );
  }, b: (A, I, g, B, Q) => {
    ...
    function A(g) {
      var _a3;
      return w = g.exports, V = w.o, hA(), IA = w.t, RA.unshift(w.p), d--, (_a3 = C2.monitorRunDependencies) == null ? void 0 : _a3.call(C2, d), d == 0 && P && (g = P, P = null, g()), w;
    }
    var I = { a: RI };
    if (d++, (_a2 = C2.monitorRunDependencies) == null ? void 0 : _a2.call(C2, d), C2.instantiateWasm)
      try {
        return C2.instantiateWasm(I, A);
      } catch (g) {
        Z(`Module.instantiateWasm callback failed with error: ${g}`), Y(g);
      }
    return z || (z = sA("zstd_codec.wasm") ? "zstd_codec.wasm" : C2.locateFile ? C2.locateFile("zstd_codec.wasm", "") : "zstd_codec.wasm"), lA(I, function(g) {
      A(g.instance);
    }).catch(Y), {};
  ...
  function nA() {
    function A() {
      var _a2;
      if (!j && (j = true, C2.calledRun = true, !GA)) {
        if (aA = true, v(RA), L(C2), (_a2 = C2.onRuntimeInitialized) == null ? void 0 : _a2.call(C2), C2.postRun)
          for (typeof C2.postRun == "function" && (C2.postRun = [C2.postRun]); C2.postRun.length; ) {
            var I = C2.postRun.shift();
            SA.unshift(I);
          }
        v(SA);
      }
    ...
    if (!(0 < d)) {
      if (C2.preRun)
        for (typeof C2.preRun == "function" && (C2.preRun = [C2.preRun]); C2.preRun.length; )
          VA();
      v(wA), 0 < d || (C2.setStatus ? (C2.setStatus("Running..."), setTimeout(function() {
        setTimeout(function() {
          C2.setStatus("");
        }, 1), A();
      }, 1)) : A());
