...
// node_modules/vitessce/dist/lerc-CEsOhIb6.js
var BA = { exports: {} };
var iA;
function tA() {
      ...
      var J = function() {
        ...
        var L = function(I, a, Q, g, D) {
          ...
          for (var a = I.pixels.numBlocksX * I.pixels.numBlocksY, Q = {}, g = 0; g < a; g++) {
            ...
            D.encoding === 0 ? Q.float32 = true : D.encoding === 1 ? Q[D.bitsPerPixel] = true : Q[0] = true;
          }
          ...
          if (g.fileVersion = B.getInt32(0, true), g.imageType = B.getInt32(4, true), g.height = B.getUint32(8, true), g.width = B.getUint32(12, true), g.maxZError = B.getFloat64(16, true), a += 24, !Q)
            if (B = new DataView(I, a, 16), g.mask = {}, g.mask.numBlocksY = B.getUint32(0, true), g.mask.numBlocksX = B.getUint32(4, true), g.mask.numBytes = B.getUint32(8, true), g.mask.maxValue = B.getFloat32(12, true), a += 16, g.mask.numBytes > 0) {
              var C = new Uint8Array(Math.ceil(g.width * g.height / 8));
              B = new DataView(I, a, g.mask.numBytes);
              var o = B.getInt16(0, true), r = 2, s = 0;
              do {
                if (o > 0)
                  for (; o--; )
                    C[s++] = B.getUint8(r++);
          ...
          B = new DataView(I, a, 16), g.pixels = {}, g.pixels.numBlocksY = B.getUint32(0, true), g.pixels.numBlocksX = B.getUint32(4, true), g.pixels.numBytes = B.getUint32(8, true), g.pixels.maxValue = B.getFloat32(12, true), a += 16;
            ...
            for (var U = 0; U < t; U++) {
              ...
              if (n !== 0 && n !== 2) {
                if (n >>= 6, w.offsetType = n, n === 2)
                  ...
                  w.offset = B.getInt16(1, true), G += 2;
                else if (n === 0)
                  w.offset = B.getFloat32(1, true), G += 4;
                else
                ...
                if (w.encoding === 1)
                  if (n = B.getUint8(G), G++, w.bitsPerPixel = n & 63, n >>= 6, w.numValidPixelsType = n, n === 2)
                    ...
                    w.numValidPixels = B.getUint16(G, true), G += 2;
                  else if (n === 0)
                    w.numValidPixels = B.getUint32(G, true), G += 4;
                  else
        ...
        var u = {
          ...
          readHeaderInfo: function(E, A) {
            ...
            I += 6;
            var g = new DataView(E, I, 8), D = g.getInt32(0, true);
            Q.fileVersion = D, I += 4, D >= 3 && (Q.checksum = g.getUint32(4, true), I += 4), g = new DataView(E, I, 12), Q.height = g.getUint32(0, true), Q.width = g.getUint32(4, true), I += 8, D >= 4 ? (Q.numDims = g.getUint32(8, true), I += 4) : Q.numDims = 1, g = new DataView(E, I, 40), Q.numValidPixel = g.getUint32(0, true), Q.microBlockSize = g.getInt32(4, true), Q.blobSize = g.getInt32(8, true), Q.imageType = g.getInt32(12, true), Q.maxZError = g.getFloat64(16, true), Q.zMin = g.getFloat64(24, true), Q.zMax = g.getFloat64(32, true), I += 40, A.headerInfo = Q, A.ptr = I;
            var B, C;
          ...
          readMask: function(E, A) {
            ...
            if (B.numBytes = D.getUint32(0, true), I += 4, (g === 0 || Q === g) && B.numBytes !== 0)
              throw "invalid mask";
            var C, o;
            if (g === 0)
              ...
              var r = D.getInt16(0, true), s = 2, f = 0, e = 0;
              do {
                if (r > 0)
                  for (; r--; )
                    C[f++] = D.getUint8(s++);
          ...
          readDataOneSweep: function(E, A, I, a) {
            ...
            if (r.length === B * D)
              a ? A.pixels.resultPixels = L.swapDimensionOrder(r, B, D, I, true) : A.pixels.resultPixels = r;
            else {
            ...
            return Q += o, A.ptr = Q, true;
          },
          readHuffmanTree: function(E, A) {
            var I = this.HUFFMAN_LUT_BITS_MAX, a = new DataView(E, A.ptr, 16);
            A.ptr += 16;
            var Q = a.getInt32(0, true);
            if (Q < 2)
              throw "unsupported Huffman version";
            var g = a.getInt32(4, true), D = a.getInt32(8, true), B = a.getInt32(12, true);
            if (D >= B)
              return false;
          ...
          decodeBits: function(E, A, I, a, Q) {
            {
              ...
              if (f === 1)
                ...
                t = o.getUint16(B, true), B += 2;
              else if (f === 4)
                t = o.getUint32(B, true), B += 4;
              else
                throw "Invalid valid pixel count type";
              ...
              if (e) {
                ...
                A.counter.bitstuffer++, y = i, A.ptr += B, y > 0 && (G = Math.ceil(t * y / 8), R = Math.ceil(G / 4), h = new ArrayBuffer(R * 4), U = new Uint8Array(h), U.set(new Uint8Array(E, A.ptr, G)), S = new Uint32Array(h), A.ptr += G, D >= 3 ? a == null ? u.originalUnstuff2(S, I, y, t) : u.unstuff2(S, I, y, t, false, a, F, k) : a == null ? u.originalUnstuff(S, I, y, t) : u.unstuff(S, I, y, t, false, a, F, k));
            }
          },
          ...
          getOnePixel: function(E, A, I, a) {
            ...
            switch (I) {
              ...
              case 2:
                ...
                break;
              case 3:
                Q = a.getUint16(A, true);
                break;
              case 4:
                Q = a.getInt32(A, true);
                break;
              case 5:
                Q = a.getUInt32(A, true);
                break;
              case 6:
                Q = a.getFloat32(A, true);
                break;
              case 7:
                Q = a.getFloat64(A, true);
                break;
              default:
...
vitessce/dist/lerc-CEsOhIb6.js:
  (* Copyright 2015-2021 Esri. Licensed under the Apache License, Version 2.0 (the "License"); you may not use this file except in compliance with the License. You may obtain a copy of the License at http://www.apache.org/licenses/LICENSE-2.0 @preserve *)
*/
//# sourceMappingURL=lerc-CEsOhIb6-SY7UYPBV.js.map
