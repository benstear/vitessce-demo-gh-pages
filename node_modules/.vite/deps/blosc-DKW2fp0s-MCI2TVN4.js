import {
  C
} from "./chunk-67ESHC7M.js";
import "./chunk-5WRI5ZAA.js";

// node_modules/vitessce/dist/blosc-DKW2fp0s.js
var GI = Object.defineProperty;
var aI = (r, Q, a) => Q in r ? GI(r, Q, { enumerable: true, configurable: true, writable: true, value: a }) : r[Q] = a;
var M = (r, Q, a) => aI(r, typeof Q != "symbol" ? Q + "" : Q, a);
var NI = (typeof document < "u" && document.currentScript && document.currentScript.src, function(r = {}) {
  var Q = r, a, S;
  Q.ready = new Promise((A, I) => {
    a = A, S = I;
  });
  var q = Object.assign({}, Q), x = "./this.program", mA = Q.print || console.log.bind(console), T = Q.printErr || console.error.bind(console);
  Object.assign(Q, q), q = null, Q.thisProgram && (x = Q.thisProgram);
  var b;
  Q.wasmBinary && (b = Q.wasmBinary), typeof WebAssembly != "object" && v("no native wasm support detected");
  var l, QA = false, P, h, V, j, n, w, EA, iA;
  function DA() {
    var A = l.buffer;
    Q.HEAP8 = P = new Int8Array(A), Q.HEAP16 = V = new Int16Array(A), Q.HEAPU8 = h = new Uint8Array(A), Q.HEAPU16 = j = new Uint16Array(A), Q.HEAP32 = n = new Int32Array(A), Q.HEAPU32 = w = new Uint32Array(A), Q.HEAPF32 = EA = new Float32Array(A), Q.HEAPF64 = iA = new Float64Array(A);
  }
  var oA = [], yA = [], FA = [];
  function ZA() {
  ...
  function v(A) {
    var _a;
    throw (_a = Q.onAbort) == null ? void 0 : _a.call(Q, A), A = "Aborted(" + A + ")", T(A), QA = true, A = new WebAssembly.RuntimeError(A + ". Build with -sASSERTIONS for more info."), S(A), A;
  }
  var GA = (A) => A.startsWith("data:application/octet-stream;base64,"), fA = (A) => A.startsWith("file://"), m;
  if (m = "blosc_codec.wasm", !GA(m)) {
    var aA = m;
    m = Q.locateFile ? Q.locateFile(aA, "") : "" + aA;
  }
  function pA(A) {
  ...
  function wA(A, I, g) {
    return pA(A).then((B) => WebAssembly.instantiate(B, I)).then((B) => B).then(g, (B) => {
      T(`failed to asynchronously prepare wasm: ${B}`), v(B);
    });
  }
  function xA(A, I) {
    var g = m;
    return b || typeof WebAssembly.instantiateStreaming != "function" || GA(g) || fA(g) || typeof fetch != "function" ? wA(g, A, I) : fetch(g, { credentials: "same-origin" }).then((B) => WebAssembly.instantiateStreaming(B, A).then(I, function(C2) {
      return T(`wasm streaming compile failed: ${C2}`), T("falling back to ArrayBuffer instantiation"), wA(g, A, I);
    }));
  }
  var u = (A) => {
    for (; 0 < A.length; )
  ...
  function PA(A) {
    this.H = A - 24, this.N = function(I) {
      w[this.H + 4 >> 2] = I;
    }, this.M = function(I) {
      w[this.H + 8 >> 2] = I;
    }, this.I = function(I, g) {
      this.J(), this.N(I), this.M(g);
    }, this.J = function() {
      w[this.H + 16 >> 2] = 0;
    };
  }
  var NA = 0, SA, k = (A) => {
    ...
    var C2 = Array(A.length), i = [], D = 0;
    A.forEach((o, E) => {
      W.hasOwnProperty(o) ? C2[E] = W[o] : (i.push(o), Z.hasOwnProperty(o) || (Z[o] = []), Z[o].push(() => {
        C2[E] = W[o], ++D, D === i.length && g(C2);
      }));
    }), i.length === 0 && g(C2);
  };
  function bA(A, I, g = {}) {
    var B = I.name;
    if (!A)
      throw new R(`type "${B}" must have a positive integer typeid pointer`);
    if (W.hasOwnProperty(A)) {
      if (g.P)
        return;
      throw new R(`Cannot register type '${B}' twice`);
    }
    W[A] = I, delete X[A], Z.hasOwnProperty(A) && (I = Z[A], delete Z[A], I.forEach((C2) => C2()));
  }
  function Y(A, I, g = {}) {
  ...
  var lA = (A, I) => {
    switch (I) {
      case 4:
        return function(g) {
          return this.fromWireType(EA[g >> 2]);
        };
      case 8:
        return function(g) {
          return this.fromWireType(iA[g >> 3]);
        };
      default:
        throw new TypeError(`invalid float width (${I}): ${A}`);
    }
  }, _ = (A, I) => Object.defineProperty(I, "name", { value: A }), jA = (A) => {
    for (; A.length; ) {
      var I = A.pop();
      A.pop()(I);
    }
  ...
  function XA(A) {
    ...
    var g = _(I.name || "unknownFunctionName", function() {
    });
  ...
  var zA = (A, I) => {
    if (Q[A].C === void 0) {
      var g = Q[A];
      Q[A] = function() {
        if (!Q[A].C.hasOwnProperty(arguments.length))
          throw new R(`Function '${I}' called with an invalid number of arguments (${arguments.length}) - expects one of (${Q[A].C})!`);
        return Q[A].C[arguments.length].apply(this, arguments);
      }, Q[A].C = [], Q[A].C[g.O] = g;
    }
  }, eA = (A, I, g) => {
    if (Q.hasOwnProperty(A)) {
      if (g === void 0 || Q[A].C !== void 0 && Q[A].C[g] !== void 0)
        throw new R(`Cannot register public name '${A}' twice`);
      if (zA(A, A), Q.hasOwnProperty(g))
        throw new R(`Cannot register multiple overloads of a function with the same number of arguments (${g})!`);
      Q[A].C[g] = I;
    } else
      Q[A] = I, g !== void 0 && (Q[A].S = g);
  }, vA = (A, I) => {
    for (var g = [], B = 0; B < A; B++)
      g.push(w[I + 4 * B >> 2]);
    return g;
    ...
    var g = [];
    return function() {
      if (g.length = 0, Object.assign(g, arguments), A.includes("j")) {
        var B = Q["dynCall_" + A];
        B = g && g.length ? B.apply(null, [I].concat(g)) : B.call(null, I);
      } else
        B = AA.get(I).apply(null, g);
      return B;
    };
  }, $A = (A, I) => {
    A = k(A);
    var g = A.includes("j") ? uA(A, I) : AA.get(I);
    if (typeof g != "function")
      throw new R(`unknown function pointer with signature ${A}: ${I}`);
    return g;
  }, JA, kA = (A) => {
    A = cA(A);
    var I = k(A);
    ...
    function g(i) {
      C2[i] || W[i] || (X[i] ? X[i].forEach(g) : (B.push(i), C2[i] = true));
    }
    var B = [], C2 = {};
    throw I.forEach(g), new JA(`${A}: ` + B.map(kA).join([", "]));
  }, AI = (A) => {
    A = A.trim();
    const I = A.indexOf("(");
    ...
    switch (I) {
      case 1:
        return g ? (B) => P[B >> 0] : (B) => h[B >> 0];
      case 2:
        return g ? (B) => V[B >> 1] : (B) => j[B >> 1];
      case 4:
        return g ? (B) => n[B >> 2] : (B) => w[B >> 2];
      default:
  ...
  for (var KA = typeof TextDecoder < "u" ? new TextDecoder("utf8") : void 0, MA = (A, I, g) => {
    var B = I + g;
    for (g = I; A[g] && !(g >= B); )
      ++g;
    if (16 < g - I && A.buffer && KA)
      return KA.decode(A.subarray(I, g));
    for (B = ""; I < g; ) {
      var C2 = A[I++];
      if (C2 & 128) {
        var i = A[I++] & 63;
        if ((C2 & 224) == 192)
          B += String.fromCharCode((C2 & 31) << 6 | i);
        else {
          var D = A[I++] & 63;
          C2 = (C2 & 240) == 224 ? (C2 & 15) << 12 | i << 6 | D : (C2 & 7) << 18 | i << 12 | D << 6 | A[I++] & 63, 65536 > C2 ? B += String.fromCharCode(C2) : (C2 -= 65536, B += String.fromCharCode(55296 | C2 >> 10, 56320 | C2 & 1023));
        }
      } else
        B += String.fromCharCode(C2);
    }
    return B;
  }, qA = typeof TextDecoder < "u" ? new TextDecoder("utf-16le") : void 0, BI = (A, I) => {
    for (var g = A >> 1, B = g + I / 2; !(g >= B) && j[g]; )
      ++g;
    if (g <<= 1, 32 < g - A && qA)
      return qA.decode(h.subarray(A, g));
    for (g = "", B = 0; !(B >= I / 2); ++B) {
      var C2 = V[A + 2 * B >> 1];
      if (C2 == 0)
        break;
      g += String.fromCharCode(C2);
    }
    return g;
  }, CI = (A, I, g) => {
    ...
    for (var C2 = 0; C2 < g; ++C2)
      V[I >> 1] = A.charCodeAt(C2), I += 2;
    return V[I >> 1] = 0, I - B;
  }, QI = (A) => 2 * A.length, EI = (A, I) => {
    for (var g = 0, B = ""; !(g >= I / 4); ) {
      var C2 = n[A + 4 * g >> 2];
      if (C2 == 0)
        break;
      ++g, 65536 <= C2 ? (C2 -= 65536, B += String.fromCharCode(55296 | C2 >> 10, 56320 | C2 & 1023)) : B += String.fromCharCode(C2);
    }
    return B;
  }, iI = (A, I, g) => {
    ...
    if (!gA) {
      ...
      for (I in IA)
        IA[I] === void 0 ? delete A[I] : A[I] = IA[I];
      var g = [];
      for (I in A)
        g.push(`${I}=${A[I]}`);
      gA = g;
    ...
    return gA;
  }, gA, oI = [null, [], []], HA = Array(256), z = 0; 256 > z; ++z)
    HA[z] = String.fromCharCode(z);
  SA = HA, R = Q.BindingError = class extends Error {
    constructor(A) {
  ...
  }, Object.assign(hA.prototype, { get(A) {
    return this.F[A];
  }, has(A) {
    return this.F[A] !== void 0;
  }, I(A) {
    var I = this.K.pop() || this.F.length;
    return this.F[I] = A, I;
  }, J(A) {
    this.F[A] = void 0, this.K.push(A);
  } }), L.F.push({ value: void 0 }, { value: null }, { value: true }, { value: false }), L.H = L.F.length, Q.count_emval_handles = () => {
    for (var A = 0, I = L.H; I < L.F.length; ++I)
      L.F[I] !== void 0 && ++A;
    return A;
  }, JA = Q.UnboundTypeError = ((A, I) => {
    var g = _(I, function(B) {
...
` + B.replace(/^Error(:[^\n]*)?\n/, ""));
  ...
  var yI = {
    p: (A, I, g) => {
      throw new PA(A).I(I, g), NA = A, NA;
    },
    o: () => {
    },
    l: (A, I, g, B) => {
      I = k(I), Y(A, { name: I, fromWireType: function(C2) {
        return !!C2;
    ...
    k: (A, I) => {
      I = k(I), Y(A, { name: I, fromWireType: (g) => {
        if (!g)
          throw new R("Cannot use deleted val. handle = " + g);
        var B = L.get(g).value;
        return RA(g), B;
      }, toWireType: (g, B) => sA(B), argPackAdvance: 8, readValueFromPointer: UA, G: null });
    },
    i: (A, I, g) => {
      I = k(I), Y(A, { name: I, fromWireType: (B) => B, toWireType: (B, C2) => C2, argPackAdvance: 8, readValueFromPointer: lA(I, g), G: null });
    },
    d: (A, I, g, B, C2, i, D) => {
      var o = vA(I, g);
      A = k(A), A = AI(A), C2 = $A(B, C2), eA(A, function() {
        _A(`Cannot call ${A} due to unbound types`, o);
      }, I - 1), OA(o, function(E) {
        var y = A, G = A;
        ...
        var s = E[1] !== null && false, d = LA(E), rA = E[0].name !== "void";
        N = [VA, N, i, jA, E[0], E[1]];
        for (var U = 0; U < F - 2; ++U)
          N.push(E[U + 2]);
        if (!d)
          for (U = s ? 1 : 2; U < E.length; ++U)
            E[U].G !== null && N.push(E[U].G);
        d = LA(E), U = E.length;
        var K = "", f = "";
        for (F = 0; F < U - 2; ++F)
          K += (F !== 0 ? ", " : "") + "arg" + F, f += (F !== 0 ? ", " : "") + "arg" + F + "Wired";
        K = `
        return function (${K}) {
        if (arguments.length !== ${U - 2}) {
          throwBindingError('function ${G} called with ' + arguments.length + ' arguments, expected ${U - 2}');
        }`, d && (K += `var destructors = [];
`);
        var tA = d ? "destructors" : "null", CA = "throwBindingError invoker fn runDestructors retType classParam".split(" ");
        for (s && (K += "var thisWired = classParam['toWireType'](" + tA + `, this);
`), F = 0; F < U - 2; ++F)
          K += "var arg" + F + "Wired = argType" + F + "['toWireType'](" + tA + ", arg" + F + "); // " + E[F + 2].name + `
`, CA.push("argType" + F);
        if (s && (f = "thisWired" + (0 < f.length ? ", " : "") + f), K += (rA || D ? "var rv = " : "") + "invoker(fn" + (0 < f.length ? ", " : "") + f + `);
`, d)
          K += `runDestructors(destructors);
`;
        else
          for (F = s ? 1 : 2; F < E.length; ++F)
            s = F === 1 ? "thisWired" : "arg" + (F - 2) + "Wired", E[F].G !== null && (K += s + "_dtor(" + s + "); // " + E[F].name + `
`, CA.push(s + "_dtor"));
        rA && (K += `var ret = retType['fromWireType'](rv);
return ret;
`);
        let [WA, FI] = [CA, K + `}
`];
        if (WA.push(FI), E = XA(WA).apply(null, N), G = _(G, E), E = I - 1, !Q.hasOwnProperty(y))
          throw new $("Replacing nonexistant public symbol");
        return Q[y].C !== void 0 && E !== void 0 ? Q[y].C[E] = G : (Q[y] = G, Q[y].O = E), [];
      });
    },
    b: (A, I, g, B, C2) => {
      if (I = k(I), C2 === -1 && (C2 = 4294967295), C2 = (o) => o, B === 0) {
        var i = 32 - 8 * g;
        C2 = (o) => o << i >>> i;
      }
      var D = I.includes("unsigned") ? function(o, E) {
        return E >>> 0;
      } : function(o, E) {
        return E;
      };
      Y(A, {
        ...
        toWireType: D,
        argPackAdvance: 8,
        readValueFromPointer: II(I, g, B !== 0),
        G: null
      });
    },
    a: (A, I, g) => {
      function B(i) {
        return new C2(P.buffer, w[i + 4 >> 2], w[i >> 2]);
      }
      var C2 = [Int8Array, Uint8Array, Int16Array, Uint16Array, Int32Array, Uint32Array, Float32Array, Float64Array][I];
      g = k(g), Y(A, { name: g, fromWireType: B, argPackAdvance: 8, readValueFromPointer: B }, { P: true });
    },
    e: (A, I) => {
      I = k(I);
      var g = I === "std::string";
      Y(A, { name: I, fromWireType: function(B) {
        var C2 = w[B >> 2], i = B + 4;
        if (g)
          for (var D = i, o = 0; o <= C2; ++o) {
            var E = i + o;
            if (o == C2 || h[E] == 0) {
              if (D = D ? MA(h, D, E - D) : "", y === void 0)
                var y = D;
              else
                y += "\0", y += D;
              D = E + 1;
          ...
          for (y = Array(C2), o = 0; o < C2; ++o)
            y[o] = String.fromCharCode(h[i + o]);
          y = y.join("");
        }
        return c(B), y;
      }, toWireType: function(B, C2) {
        C2 instanceof ArrayBuffer && (C2 = new Uint8Array(C2));
        var i, D = typeof C2 == "string";
        if (!(D || C2 instanceof Uint8Array || C2 instanceof Uint8ClampedArray || C2 instanceof Int8Array))
          throw new R("Cannot pass non-string to std::string");
        var o;
        if (g && D)
          for (i = o = 0; i < C2.length; ++i) {
            var E = C2.charCodeAt(i);
            127 >= E ? o++ : 2047 >= E ? o += 2 : 55296 <= E && 57343 >= E ? (o += 4, ++i) : o += 3;
          }
        else
          o = C2.length;
        if (i = o, o = BA(4 + i + 1), E = o + 4, w[o >> 2] = i, g && D) {
          if (D = E, E = i + 1, i = h, 0 < E) {
            E = D + E - 1;
            for (var y = 0; y < C2.length; ++y) {
              var G = C2.charCodeAt(y);
              if (55296 <= G && 57343 >= G) {
                var N = C2.charCodeAt(++y);
          ...
          for (D = 0; D < i; ++D) {
            if (y = C2.charCodeAt(D), 255 < y)
              throw c(E), new R("String has UTF-16 code units that do not fit in 8 bits");
            h[E + D] = y;
          }
        else
          for (D = 0; D < i; ++D)
            h[E + D] = C2[D];
        return B !== null && B.push(c, o), o;
      }, argPackAdvance: 8, readValueFromPointer: gI, G(B) {
        c(B);
      } });
    },
    c: (A, I, g) => {
      if (g = k(g), I === 2)
        var B = BI, C2 = CI, i = QI, D = () => j, o = 1;
      else
        I === 4 && (B = EI, C2 = iI, i = DI, D = () => w, o = 2);
      Y(A, { name: g, fromWireType: (E) => {
        for (var y = w[E >> 2], G = D(), N, F = E + 4, s = 0; s <= y; ++s) {
          var d = E + 4 + s * I;
          (s == y || G[d >> o] == 0) && (F = B(F, d - F), N === void 0 ? N = F : (N += "\0", N += F), F = d + I);
        }
        return c(E), N;
      }, toWireType: (E, y) => {
        if (typeof y != "string")
          throw new R(`Cannot pass non-string to C++ string type ${g}`);
        var G = i(y), N = BA(4 + G + I);
        return w[N >> 2] = G >> o, C2(y, N + 4, G + I), E !== null && E.push(c, N), N;
      }, argPackAdvance: 8, readValueFromPointer: UA, G(E) {
        c(E);
      } });
    },
    m: (A, I) => {
      I = k(I), Y(A, { R: true, name: I, argPackAdvance: 0, fromWireType: () => {
      }, toWireType: () => {
      } });
    },
    g: RA,
    ...
    f: (A, I) => {
      var g = W[A];
      if (g === void 0)
        throw A = "_emval_take_value has unknown type " + kA(A), new R(A);
      return A = g, A = A.readValueFromPointer(I), sA(A);
    },
    h: () => {
      v("");
    },
    v: (A, I, g) => h.copyWithin(A, I, I + g),
    q: (A) => {
      var I = h.length;
      if (A >>>= 0, 2147483648 < A)
        return false;
      for (var g = 1; 4 >= g; g *= 2) {
        ...
        B = Math.max(A, B);
        A: {
          C2 = (C2.min.call(C2, 2147483648, B + (65536 - B % 65536) % 65536) - l.buffer.byteLength + 65535) / 65536;
          try {
            l.grow(C2), DA();
            var i = 1;
            break A;
    ...
    t: (A, I) => {
      var g = 0;
      return YA().forEach((B, C2) => {
        var i = I + g;
        for (C2 = w[A + 4 * C2 >> 2] = i, i = 0; i < B.length; ++i)
          P[C2++ >> 0] = B.charCodeAt(i);
        P[C2 >> 0] = 0, g += B.length + 1;
      }), 0;
    },
    u: (A, I) => {
      var g = YA();
      w[A >> 2] = g.length;
      var B = 0;
      return g.forEach((C2) => B += C2.length + 1), w[I >> 2] = B, 0;
    },
    s: () => 52,
    n: function() {
      return 70;
    ...
    r: (A, I, g, B) => {
      for (var C2 = 0, i = 0; i < g; i++) {
        var D = w[I >> 2], o = w[I + 4 >> 2];
        I += 8;
        for (var E = 0; E < o; E++) {
          var y = h[D + E], G = oI[A];
          y === 0 || y === 10 ? ((A === 1 ? mA : T)(MA(G, 0)), G.length = 0) : G.push(y);
        }
        C2 += o;
      }
      return w[B >> 2] = C2, 0;
    ...
    function A(g) {
      var _a2;
      return H = g.exports, l = H.w, DA(), AA = H.A, yA.unshift(H.x), t--, (_a2 = Q.monitorRunDependencies) == null ? void 0 : _a2.call(Q, t), t == 0 && O && (g = O, O = null, g()), H;
    }
    var I = { a: yI };
    if (t++, (_a = Q.monitorRunDependencies) == null ? void 0 : _a.call(Q, t), Q.instantiateWasm)
      try {
        ...
        T(`Module.instantiateWasm callback failed with error: ${g}`), S(g);
      }
    return xA(I, function(g) {
      A(g.instance);
    }).catch(S), {};
  }(), BA = (A) => (BA = H.y)(A), c = (A) => (c = H.z)(A), cA = (A) => (cA = H.B)(A);
  Q.dynCall_jiji = (A, I, g, B, C2) => (Q.dynCall_jiji = H.D)(A, I, g, B, C2);
  var e;
  O = function A() {
    e || dA(), e || (O = A);
  };
  function dA() {
    function A() {
      if (!e && (e = true, Q.calledRun = true, !QA)) {
        if (u(yA), a(Q), Q.onRuntimeInitialized && Q.onRuntimeInitialized(), Q.postRun)
    ...
    if (!(0 < t)) {
      if (Q.preRun)
        for (typeof Q.preRun == "function" && (Q.preRun = [Q.preRun]); Q.preRun.length; )
          ZA();
      u(oA), 0 < t || (Q.setStatus ? (Q.setStatus("Running..."), setTimeout(function() {
        setTimeout(function() {
          Q.setStatus("");
        }, 1), A();
      }, 1)) : A());
