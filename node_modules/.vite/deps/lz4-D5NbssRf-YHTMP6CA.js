...
// node_modules/vitessce/dist/lz4-D5NbssRf.js
var EI = Object.defineProperty;
var iI = (J, Q, D) => Q in J ? EI(J, Q, { enumerable: true, configurable: true, writable: true, value: D }) : J[Q] = D;
...
var tI = (typeof document < "u" && document.currentScript && document.currentScript.src, function(J = {}) {
  ...
  function z(A) {
    var _a;
    throw (_a = Q.onAbort) == null ? void 0 : _a.call(Q, A), A = "Aborted(" + A + ")", U(A), CA = true, A = new WebAssembly.RuntimeError(A + ". Build with -sASSERTIONS for more info."), d(A), A;
  }
  ...
  function YA(A, I) {
    ...
    return X || typeof WebAssembly.instantiateStreaming != "function" || aA(B) || SA(B) || typeof fetch != "function" ? sA(B, A, I) : fetch(B, { credentials: "same-origin" }).then((g) => WebAssembly.instantiateStreaming(g, A).then(I, function(C2) {
      return U(`wasm streaming compile failed: ${C2}`), U("falling back to ArrayBuffer instantiation"), sA(B, A, I);
    }));
  }
  var $ = (A) => {
    for (; 0 < A.length; )
...
`];
    ...
    function A(B) {
      var _a2;
      return k = B.exports, P = k.r, rA(), IA = k.w, eA.unshift(k.s), W--, (_a2 = Q.monitorRunDependencies) == null ? void 0 : _a2.call(Q, W), W == 0 && q && (B = q, q = null, B()), k;
    }
    var I = { a: QI };
    if (W++, (_a = Q.monitorRunDependencies) == null ? void 0 : _a.call(Q, W), Q.instantiateWasm)
      try {
        ...
        U(`Module.instantiateWasm callback failed with error: ${B}`), d(B);
      }
...
}, L(p, "codecId", "lz4"), L(p, "DEFAULT_ACCELERATION", QA), L(p, "max_buffer_size", Z), p);
var DI = aI;
export {
  DI as default
};
//# sourceMappingURL=lz4-D5NbssRf-YHTMP6CA.js.map
