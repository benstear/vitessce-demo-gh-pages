...
import { registerLayerType, registerLayerTypeDetector, UserLayer } from './layer'; /**
                                                                                    * @license
...
import { getShaderAttributeType, pickAttributeNames, SingleMeshDisplayState, SingleMeshLayer } from './single_mesh/frontend';
...
export class SingleMeshUserLayer extends UserLayer {
    constructor(managedLayer) {
        ...
        this.displayState = new SingleMeshDisplayState();
        this.vertexAttributes = new WatchableValue(undefined);
    ...
    activateDataSubsources(subsources) {
        ...
        for (const loadedSubsource of subsources) {
            ...
            const singleMesh = subsource.singleMesh;
            ...
            if (singleMesh !== undefined) {
                ...
                loadedSubsource.activate(refCounted => {
                    loadedSubsource.addRenderLayer(new SingleMeshLayer(singleMesh, this.displayState, loadedSubsource.getRenderLayerTransform()));
...
SingleMeshUserLayer.type = 'mesh';
SingleMeshUserLayer.typeAbbreviation = 'mesh';
...
class DisplayOptionsTab extends Tab {
    constructor(layer) {
        ...
        element.appendChild(this.registerDisposer(new ShaderControls(layer.displayState.shaderControlState, this.layer.manager.root.display, this.layer, { visibility: this.visibility })).element);
    }
}
