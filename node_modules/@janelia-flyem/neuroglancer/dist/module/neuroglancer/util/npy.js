 ...
 */
import { DATA_TYPE_ARRAY_CONSTRUCTOR, DATA_TYPE_BYTES, DATA_TYPE_JAVASCRIPT_ELEMENTS_PER_ARRAY_ELEMENT } from './data_type';
import { convertEndian } from './endian';
import { pythonLiteralParse } from './json';
import { parseNumpyDtype } from './numpy_dtype';
...
export function parseNpy(x) {
    ...
    var _parseNumpyDtype = parseNumpyDtype(dtype);

    const dataType = _parseNumpyDtype.dataType,
          endianness = _parseNumpyDtype.endianness;
