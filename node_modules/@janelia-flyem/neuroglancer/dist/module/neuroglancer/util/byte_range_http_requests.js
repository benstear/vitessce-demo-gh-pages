 ...
 */
import { getByteRangeHeader, responseArrayBuffer } from './http_request';
import { cancellableFetchSpecialOk } from './special_protocol_request';
/**
...
export function fetchSpecialHttpByteRange(credentialsProvider, url, startOffset, endOffset, cancellationToken) {
