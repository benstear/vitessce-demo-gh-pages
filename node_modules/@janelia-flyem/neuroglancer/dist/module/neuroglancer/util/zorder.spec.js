...
describe('decodeZIndexCompressed', () => {
    it('works for repetitive pattern 21,21,21', () => {
        expect(decodeZIndexCompressed(Uint64.parseString('111000100010001111000100010001111000100010001', 2), 21, 21, 21)).toEqual(Uint32Array.of(0b100011000110001, 0b100101001010010, 0b101001010010100));
    });
    it('works for repetitive pattern 18,15,17', () => {
        expect(decodeZIndexCompressed(Uint64.parseString('11101111000100010001111000100010001111000100010001', 2), 18, 15, 17)).toEqual(Uint32Array.of(0b111100011000110001, 0b100101001010010, 0b10101001010010100));
    });
});
