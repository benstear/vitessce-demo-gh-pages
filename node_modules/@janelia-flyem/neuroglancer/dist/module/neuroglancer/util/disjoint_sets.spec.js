...
function getSortedElementStrings(disjointSets, x) {
    let members = _Array$from(disjointSets.setElements(x));
...
describe('disjoint_sets', () => {
    it('basic', () => {
        ...
        for (let i = 25; i < 49; ++i) {
            ...
            expect(getSortedElementStrings(disjointSets, a)).toEqual(getContiguousElementStrings(25, i + 2));
        }
        ...
        for (let i = 51; i < 100; ++i) {
            expect(getSortedElementStrings(disjointSets, new Uint64(i, 0))).toEqual(getContiguousElementStrings(i, i + 1));
        }
    });
    it('toJSON', () => {
        let disjointSets = new DisjointUint64Sets();
