 ...
 */
import { AnnotationSerializer, AnnotationType, makeAnnotationPropertySerializers } from './index';
import { deleteAnnotation, makeTemporaryChunk, updateAnnotation } from './frontend_source';
class UpdateTester {
    constructor(rank, propertySpecs) {
        this.annotations = [];
        this.incrementalChunk = makeTemporaryChunk();
    ...
    delete(id, type) {
        ...
        expect(deleteAnnotation(this.incrementalChunk.data, type, id, this.propertySerializers)).toBe(true);
        this.compare();
    }
}
describe('updateAnnotations', () => {
    it('rank 1', () => {
        ...
        tester.compare();
        tester.update({ id: 'a', type: AnnotationType.POINT, point: Float32Array.of(1, 2), properties: [] });
        tester.delete('a', AnnotationType.POINT);
        tester.update({ id: 'a', type: AnnotationType.POINT, point: Float32Array.of(1, 2), properties: [] });
        tester.update({ id: 'b', type: AnnotationType.POINT, point: Float32Array.of(2, 3), properties: [] });
        tester.update({
            id: 'c',
...
//# sourceMappingURL=frontend_source.spec.js.map