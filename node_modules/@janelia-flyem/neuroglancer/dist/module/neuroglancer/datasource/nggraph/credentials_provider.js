...
function makeOriginError(serverUrl) {
    return new Error(`Nggraph server ${serverUrl} does not allow requests from Neuroglancer instance ${self.origin}`);
}
...
export class NggraphCredentialsProvider extends CredentialsProvider {
