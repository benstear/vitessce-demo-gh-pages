 ...
 */
import { computeNearIsotropicDownsamplingLevels } from './frontend';
describe('computeNearIsotropicDownsamplingLevels', () => {
    it('works for simple examples', () => {
        ...
        expect(computeNearIsotropicDownsamplingLevels(shape, downsampleDims, effectiveVoxelSize, maxDownsampling, maxDownsamplingScales, maxDownsampledSize)).toEqual([Float32Array.of(1, 1, 1), Float32Array.of(2, 2, 2), Float32Array.of(4, 4, 4)]);
    });
});
