...
import { glsl_addSaturateInt32, glsl_addSaturateUint32, glsl_addSaturateUint64, glsl_log2Exact, glsl_shiftLeftSaturateUint32, glsl_subtractSaturateInt32, glsl_subtractSaturateUint32 } from './shader_lib';
...
describe('uint32ShiftLeftSaturate', () => {
    it('works for examples', () => {
        fragmentShaderTest({ inputValue: 'uint', shiftAmount: 'int' }, { outputValue: 'uint' }, tester => {
            ...
            const compute = (inputValue, shiftAmount) => {
...
describe('uint32SubtractSaturate', () => {
    it('works for examples', () => {
        fragmentShaderTest({ inputA: 'uint', inputB: 'uint' }, { outputValue: 'uint' }, tester => {
            ...
            builder.setFragmentMain(`outputValue = subtractSaturate(inputA, inputB);`);
            const compute = (a, b) => {
                tester.execute({ inputA: a, inputB: b });
                return tester.values.outputValue;
            };
...
describe('uint64AddSaturate', () => {
    ...
    it('works for examples', () => {
        fragmentShaderTest({ inputA: DataType.UINT64, inputB: DataType.UINT64 }, { outputValue: DataType.UINT64 }, tester => {
            const builder = tester.builder;
...
//# sourceMappingURL=shader_lib.spec.js.map