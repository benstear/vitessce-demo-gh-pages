...
import { computeTextureFormat, OneDimensionalTextureAccessHelper, setOneDimensionalTextureData, TextureFormat } from './texture_access';
function testTextureAccess(dataLength) {
    ...
    fragmentShaderTest({ uOffset: 'uint' }, { outputValue: dataType }, tester => {
        ...
        const textureUnitSymbol = _Symbol('textureUnit');
