...
import { parseShaderUiControls, stripComments } from './shader_ui_controls';
...
`;
        expect(parseShaderUiControls(code)).toEqual({ source: code, code, errors: [], controls: new _Map() });
    });
...
`;
        expect(parseShaderUiControls(code)).toEqual({
            ...
            code: newCode,
            errors: [],
            controls: new _Map([['brightness', { type: 'slider', valueType: 'float', min: 0, max: 1, default: 0.5, step: 0.01 }]])
        });
    });
...
`;
        expect(parseShaderUiControls(code)).toEqual({
            ...
            code: newCode,
            errors: [],
            controls: new _Map([['myCheckbox', { type: 'checkbox', valueType: 'bool', default: false }], ['myCheckbox2', { type: 'checkbox', valueType: 'bool', default: true }]])
        });
    });
...
`;
        expect(parseShaderUiControls(code)).toEqual({
            ...
            code: newCode,
            errors: [],
            controls: new _Map([['color', { type: 'color', valueType: 'vec3', default: vec3.fromValues(1, 0, 0), defaultString: 'red' }]])
        });
    });
...
//# sourceMappingURL=shader_ui_controls.spec.js.map