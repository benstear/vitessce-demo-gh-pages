...
export function chunkFormatTest(dataType, volumeSize, getChunkFormatAndTextureLayout, rawData, encodedData) {
    ...
    it(`volumeSize = ${volumeSize.join()}, numChannels = ${volumeSize[3]}, ` + `dataType = ${DataType[dataType]}`, () => {
        fragmentShaderTest({}, outputs, tester => {
            ...
            let chunkFormat = _getChunkFormatAndTex2[0],
...
`;
            ...
            chunkFormat.setupTextureLayout(gl, shader, textureLayout, fixedChunkPosition, chunkDisplaySubspaceDimensions,
            /*channelDimensions=*/[3]);
            ...
            function checkPosition(positionInChunk) {
                ...
                for (let channel = 0; channel < numChannels; ++channel) {
                    ...
                    const msg = `volumeSize = ${vec3Key(volumeSize)}, ` + `positionInChunk = ${vec3Key(positionInChunk)}, ` + `channel = ${channel}, offset = ${curOffset}`;
                    switch (dataType) {
