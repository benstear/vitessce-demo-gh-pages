...
describe('compressed_segmentation uint64', () => {
    describe('encodeBlock', () => {
        ...
        it('basic 0-bit', () => {
            ...
            let encodedBits = _encodeBlock2[0],
        ...
        it('basic 0-bit preserve existing', () => {
            ...
            let encodedBits = _encodeBlock4[0],
        ...
        it('basic 1-bit', () => {
            ...
            let encodedBits = _encodeBlock6[0],
        ...
        it('size mismatch 1-bit', () => {
            ...
            let encodedBits = _encodeBlock8[0],
        ...
        it('basic 2-bit', () => {
            ...
            let encodedBits = _encodeBlock10[0],
    ...
    describe('encodeChannel', () => {
        ...
        it('basic cached 0-bit', () => {
            const input = Uint32Array.of(4, 0, 4, 0, 4, 0, 4, 0, //
            3, 0, 3, 0, 3, 0, 3, 0, //
            3, 0, 3, 0, 3, 0, 3, 0, //
            4, 0, 4, 0, 4, 0, 4, 0 //
            );
        ...
        for (let volumeSize of [[1, 2, 1], [2, 2, 2], [4, 4, 5]]) {
    ...
    describe('encodeChannels', () => {
        ...
        for (let volumeSize of [[1, 2, 1, 1], [1, 2, 1, 3], [2, 2, 2, 1], [2, 2, 2, 3], [4, 4, 5, 3]]) {
            it(`round trip ${volumeSize.join(',')}`, () => {
                const numPossibleValues = 15;
