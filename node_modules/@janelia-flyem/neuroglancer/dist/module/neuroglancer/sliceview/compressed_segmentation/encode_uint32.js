...
export function encodeChannel(output, blockSize, rawData, volumeSize, baseInputOffset = 0, inputStrides = getFortranOrderStrides(volumeSize, 1)) {
    return encodeChannelCommon(output, blockSize, rawData, volumeSize, baseInputOffset, inputStrides, encodeBlock);
}
export function encodeChannels(output, blockSize, rawData, volumeSize, baseInputOffset = 0, inputStrides = getFortranOrderStrides(volumeSize, 1)) {
