...
import { decodeRawChunk } from './raw';
import { decodePng } from '../../async_computation/decode_png_request';
import { requestAsyncComputation } from '../../async_computation/request';
export async function decodePngChunk(chunk, cancellationToken, response) {
  const chunkDataSize = chunk.chunkDataSize;
  const dataType = chunk.source.spec.dataType;
  let image = await requestAsyncComputation(decodePng, cancellationToken, [response],
