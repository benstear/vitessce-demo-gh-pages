...
describe('gpu_hash.shader', () => {
    it('hashCombineUint32', () => {
        fragmentShaderTest({ inputValue: 'uint', hashSeed: 'uint' }, { outputValue: 'uint' }, tester => {
            ...
            const testHash = (hashSeed, inputValue) => {
    ...
    it('hashCombine', () => {
        fragmentShaderTest({ inputValue: DataType.UINT64, hashSeed: 'uint' }, { outputValue: 'uint' }, tester => {
            const builder = tester.builder;
    ...
    it('GPUHashTable:HashSetUint64', () => {
        fragmentShaderTest({ inputValue: DataType.UINT64 }, { outputValue: 'bool' }, tester => {
            ...
            let notPresentValues = new Array();
    ...
    it('GPUHashTable:HashMapUint64', () => {
        fragmentShaderTest({ key: DataType.UINT64 }, { isPresent: 'bool', outputValue: DataType.UINT64 }, tester => {
            let gl = tester.gl,
                builder = tester.builder;
