 ...
 */
import { mergeSegmentPropertyMaps, PreprocessedSegmentPropertyMap, SegmentPropertyMap } from './property_map';
import { Uint64 } from '../util/uint64';
describe('PreprocessedSegmentPropertyMap', () => {
    it('handles lookups correctly', () => {
        const map = new PreprocessedSegmentPropertyMap({ inlineProperties: { ids: Uint32Array.of(5, 0, 15, 0, 20, 5), properties: [] } });
...
describe('mergeSegmentPropertyMaps', () => {
    it('works correctly for 2 maps', () => {
        ...
        expect(c === null || c === void 0 ? void 0 : c.inlineProperties).toEqual({
            ids: Uint32Array.of(5, 0, 6, 0, 7, 0, 8, 0),
            properties: [{ type: 'string', id: 'prop1', values: ['x', 'y', '', 'z'] }, { type: 'string', id: 'prop2', values: ['a', '', 'b', ''] }]
        });
    });
});
//# sourceMappingURL=property_map.spec.js.map