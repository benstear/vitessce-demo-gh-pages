...
class Spatial extends AbstractSpatialOrScatterplot {
    ...
    createPolygonSegmentationsLayer(layerDef, hasExplicitPolygons) {
        ...
        const { theme, 
        // cellFilter,
        cellSelection, setCellHighlight, setComponentHover, setHoverInfo, getCellIsSelected = makeDefaultGetCellIsSelected(obsIndex.length === cellSelection.length ? null : cellSelection), cellColors, getCellColor = makeDefaultGetCellColors(cellColors, obsIndex, theme), onCellClick, lineWidthScale = 10, lineWidthMaxPixels = 2, geneExpressionColormapRange, cellColorEncoding, getExpressionValue, geneExpressionColormap, } = this.props;
    ...
    createMoleculesLayer(layerDef) {
        const { obsLocations, obsLocationsFeatureIndex: obsLabelsTypes, setMoleculeHighlight, setHoverInfo, setComponentHover, obsLocationsIndex, } = this.props;
        ...
        return new deck.ScatterplotLayer({
            ...
            onHover: (info) => {
                const standardOnHoverCallback = getOnHoverCallback(obsLocationsIndex, setMoleculeHighlight, setComponentHover);
