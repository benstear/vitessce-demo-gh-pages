...
export default function SpatialTooltipSubscriber(props) {
    const { parentUuid, obsHighlight, width, height, getObsInfo, hoverData, hoverCoord, hoverMode, useHoverInfoForTooltip, getObsIdFromHoverData, featureType, featureLabelsMap, } = props;
    ...
    else if (useHoverInfoForTooltip && getObsIdFromHoverData
