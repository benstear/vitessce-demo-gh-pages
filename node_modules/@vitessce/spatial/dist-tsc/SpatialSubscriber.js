...
export function SpatialSubscriber(props) {
    ...
    }, 10, { trailing: true }), [setHoverData, setHoverCoord, setHoverMode]);
    ...
    return (_jsxs(TitleInfo, { title: title, info: subtitle, isSpatial: true, urls: urls, theme: theme, closeButtonVisible: closeButtonVisible, downloadButtonVisible: downloadButtonVisible, removeGridComponent: removeGridComponent, isReady: isReady, options: options, helpText: helpText, children: [_jsx("div", { style: {
                    position: 'absolute',
                    bottom: '5px',
                    left: '5px',
                    zIndex: 6,
                ...
                }, updateViewInfo: setComponentViewInfo, imageLayerCallbacks: imageLayerCallbacks, segmentationLayerCallbacks: segmentationLayerCallbacks, spatialAxisFixed: spatialAxisFixed, geneExpressionColormap: geneExpressionColormap, geneExpressionColormapRange: geneExpressionColormapRange, expressionData: shiftedExpressionDataForBitmask, cellColorEncoding: cellColorEncoding, getExpressionValue: getExpressionValue, theme: theme, useFullResolutionImage: useFullResolutionImage, photometricInterpretation: photometricInterpretation }), tooltipsVisible && (_jsx(SpatialTooltipSubscriber, { parentUuid: uuid, obsHighlight: cellHighlight || moleculeHighlight, width: width, height: height, getObsInfo: getTooltipObsInfo, useHoverInfoForTooltip: useHoverInfoForTooltip, hoverData: hoverData, hoverCoord: hoverCoord, hoverMode: hoverMode, getObsIdFromHoverData: getObsIdFromHoverData, featureType: featureType, featureLabelsMap: featureLabelsMap })), _jsx(Legend, { visible: true, 
                // Fix to dark theme due to black background of spatial plot.
                theme: "dark", featureType: featureType, featureValueType: featureValueType, obsColorEncoding: cellColorEncoding, obsSetSelection: cellSetSelection, featureSelection: geneSelection, featureLabelsMap: featureLabelsMap, featureValueColormap: geneExpressionColormap, featureValueColormapRange: geneExpressionColormapRange, extent: expressionExtents?.[0] })] }));
}
