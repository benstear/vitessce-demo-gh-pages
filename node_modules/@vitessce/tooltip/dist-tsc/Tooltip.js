...
export default function Tooltip(props) {
    ...
    return (_jsx("div", { ref: ref, className: classes.tooltipAnchor, children: ref && ref.current ? (_jsx(PopperV4, { open: true, anchorEl: ref.current, container: getTooltipContainer, transition: true, placement: `${placementY}-${placementX}`, children: _jsx(Paper, { elevation: 8, className: classes.tooltipContent, children: children }) })) : null }));
}
