...
export const Popper = React.forwardRef((props, ref) => {
    const { anchorEl, children, container, disablePortal = false, keepMounted = false, modifiers, open, placement: initialPlacement = 'bottom', popperOptions = defaultPopperOptions, popperRef: popperRefProp, style, transition = false, ...other } = props;
    ...
    return (_jsx(Portal, { disablePortal: disablePortal, container: container, children: _jsx("div", { ref: handleRef, role: "tooltip", ...other, style: {
