...
class Spatial extends AbstractSpatialOrScatterplot {
    ...
    createBitmaskSegmentationLayer(layerScope, layerCoordination, channelScopes, channelCoordination, image, layerFeatureValues, layerMatrixObsIndices, bitmaskValueIsIndex) {
        ...
        const nextLoaderSelection = channelScopes
            ...
            z: targetZ,
            t: targetT,
            c: image?.obsSegmentations?.instance?.getChannelIndex(channelCoordination[cScope][CoordinationType.SPATIAL_TARGET_C]),
        }));
    ...
    createImageLayer(layerScope, layerCoordination, channelScopes, channelCoordination, image) {
        ...
        const nextLoaderSelection = isRgb ? ([0, 1, 2])
            ...
            z: targetZ,
            t: targetT,
            c: image?.image?.instance?.getChannelIndex(channelCoordination[cScope][CoordinationType.SPATIAL_TARGET_C]),
        }));
