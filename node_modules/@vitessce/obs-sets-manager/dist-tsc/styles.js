...
export function SetsManagerTreeGlobalStyles(props) {
    ...
    return (_jsx(ScopedGlobalStyles, { parentClassName: classes.setsManagerTree, styles: {
            '.rc-tree': {
                paddingLeft: '0',
                margin: '0',
                border: '1px solid transparent',
...
export function AntTooltipGlobalStyles() {
    return (_jsx(GlobalStyles, { styles: antTooltipGlobalStyles }));
}
/*
...
export function HelpTooltipGlobalStyles(props) {
    const { classes } = props;
    return (_jsx(ScopedGlobalStyles, { parentClassName: classes.helpTooltip, styles: {
            '.rc-tooltip-inner': {
                fontSize: '10px',
                minWidth: '30px',
                padding: '6px 8px',
...
export function PopoverGlobalStyles(props) {
    const { classes } = props;
    const { theme } = useTheme();
    return (_jsx(ScopedGlobalStyles, { parentClassName: classes.popover, styles: {
            '.rc-tooltip-inner': {
                boxSizing: 'border-box',
