...
export function SetOperationButtons(props) {
    ...
    return (_jsx(_Fragment, { children: operatable && (_jsxs(_Fragment, { children: [_jsx("button", { onClick: onUnion, title: unionText, type: "submit", disabled: !hasCheckedSetsToUnion, children: _jsx(SetUnionSVG, {}) }), _jsx("button", { onClick: onIntersection, title: intersectionText, type: "submit", disabled: !hasCheckedSetsToIntersect, children: _jsx(SetIntersectionSVG, {}) }), _jsx("button", { onClick: onComplement, title: complementText, type: "submit", disabled: !hasCheckedSetsToComplement, children: _jsx(SetComplementSVG, {}) })] })) }));
}
