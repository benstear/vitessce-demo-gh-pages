...
export default function Description(props) {
    ...
    return (_jsxs("div", { className: classes.description, children: [descriptionType && descriptionType === DescriptionType.MARKDOWN
                ? _jsx(Markdown, { children: description }) : _jsx("p", { children: description }), metadata && Array.from(metadata.entries())
