...
const LayerControllerMemoized = React.memo(forwardRef((props, ref) => {
    ...
    return (_jsx(TitleInfo, { title: title, isScroll: true, closeButtonVisible: closeButtonVisible, downloadButtonVisible: downloadButtonVisible, removeGridComponent: removeGridComponent, theme: theme, isReady: isReady, helpText: helpText, children: _jsxs("div", { className: "layer-controller-container", ref: ref, children: [moleculesLayer && (_jsx(VectorLayerController, { label: "Molecules", layerType: "molecules", layer: moleculesLayer, handleLayerChange: setMoleculesLayer }, `${dataset}-molecules`)), cellsLayer && obsSegmentationsType === 'polygon' && (_jsx(VectorLayerController, { label: `${capitalize(obsType)} Segmentations`, layerType: "cells", layer: cellsLayer, handleLayerChange: setCellsLayer }, `${dataset}-cells`)), cellsLayer && obsSegmentationsType === 'bitmask'
                        ...
                        , { sx: { marginTop: '10px' }, children: _jsx(LayerController, { name: layerMeta.name, layer: layer, loader: loader, theme: theme, handleLayerChange: v => handleRasterLayerChange(v, i), handleLayerRemove: () => handleRasterLayerRemove(i), ChannelController: RasterChannelController, shouldShowTransparentColor: isRaster, shouldShowDomain: isRaster, shouldShowColormap: isRaster, 
                                ...
                                disable3d: globalDisable3d
                                    ...
                                    || (typeof layerIs3DIndex === 'number'
                                        ...
                                        && layerIs3DIndex !== i), disabled: typeof layerIs3DIndex === 'number'
                                    && layerIs3DIndex !== -1
                                    && layerIs3DIndex !== i, disableChannelsIfRgbDetected: disableChannelsIfRgbDetected, photometricInterpretation: photometricInterpretation, imageLayerCallbacks: imageLayerCallbacks, setImageLayerCallback: setImageLayerCallback, setViewState: ({ zoom: newZoom, target, rotationX: newRotationX, rotationOrbit: newRotationOrbit, }) => {
                                    setZoom(newZoom);
                                    setTargetX(target[0]);
                                    setTargetY(target[1]);
                                    setTargetZ(target[2]);
                    ...
                    ? (_jsx(Grid, { children: _jsx(ImageAddButton, { imageOptions: imageLayerMeta, handleImageAdd: handleImageAdd }) })) : null] }) }));
}));
/**
...
export function LayerControllerSubscriber(props) {
    const { coordinationScopes, closeButtonVisible, downloadButtonVisible, removeGridComponent, theme, title = 'Spatial Layers', disable3d, globalDisable3d, disableChannelsIfRgbDetected, enableLayerButtonsWithOneLayer, helpText = ViewHelpMapping.LAYER_CONTROLLER, } = props;
    ...
    const photometricInterpretation = (photometricInterpretationFromCoordination
