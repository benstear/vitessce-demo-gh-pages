...
export default function VectorLayerController(props) {
    ...
    return (_jsx(Grid, { sx: { marginTop: '10px' }, children: _jsxs(Paper, { elevation: 4, className: classes.layerControllerRoot, children: [_jsx(Typography, { style: {
                        padding: '15px 8px 0px 8px',
                        marginBottom: '-5px',
                    }, children: label }), _jsxs(Grid, { container: true, direction: "row", justifyContent: "space-between", children: [_jsx(Grid, { size: 2, children: _jsx(Checkbox, { color: "primary", checked: isOn, onChange: (e, v) => handleCheckBoxChange(v), slotProps: { input: { 'aria-label': 'Show or hide vector layer' } } }) }), _jsx(Grid, { size: 9, sx: { paddingRight: '16px' }, children: _jsx(Slider, { value: slider, min: 0, max: 1, step: 0.001, onChange: (e, v) => handleSliderChange(v), style: { marginTop: '7px' }, orientation: "horizontal", getAriaLabel: (index) => {
