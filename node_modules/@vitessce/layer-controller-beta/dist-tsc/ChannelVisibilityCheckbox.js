...
import { Checkbox, makeStyles, } from '@vitessce/styles';
...
export default function ChannelVisibilityCheckbox(props) {
    ...
    return (_jsx(Checkbox, { onChange: (e, v) => setVisible(v), checked: visible, disabled: disabled, className: classes.visibilityCheckbox, style: { color: rgbColor, '&$checked': { color: rgbColor } }, slotProps: { input: { 'aria-label': 'Toggle channel visibility' } } }));
}
