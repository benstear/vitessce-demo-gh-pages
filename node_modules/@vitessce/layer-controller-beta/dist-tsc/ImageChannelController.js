...
export default function ImageChannelController(props) {
    ...
    return (_jsxs(Grid, { container: true, direction: "row", justifyContent: "space-between", children: [_jsx(Grid, { size: 1, children: _jsx(ChannelVisibilityCheckbox, { color: color, setColor: setColor, visible: visible, setVisible: setVisible, disabled: isLoading, theme: theme, colormapOn: colormapOn }) }), _jsx(Grid, { size: 1, children: _jsx(ChannelColorPickerMenu, { color: color, setColor: setColor, visible: visible, setVisible: setVisible, disabled: isLoading, theme: theme, isStaticColor: !colormapOn, palette: VIEWER_PALETTE }) }), _jsx(Grid, { size: 6, children: _jsx(ChannelSelectionDropdown, { featureIndex: featureIndex, targetC: targetC, setTargetC: setTargetC, setWindow: setWindow, disabled: isLoading }) }), _jsx(Grid, { size: 3, children: _jsx(ChannelSlider, { image: image, targetT: targetT, targetZ: targetZ, targetC: targetC, window: window, setWindow: setWindow, disabled: disabled, color: color, theme: theme, colormapOn: colormapOn, showValueExtent: showValueExtent, minMaxDomain: minMaxDomain }) }), _jsx(Grid, { size: 1, children: _jsx(ChannelOptions, { onRemove: onRemove, showValueExtent: showValueExtent, setShowValueExtent: setShowValueExtent, onResetWindowUsingIQR: handleResetWindowUsingIQR }) })] }));
}
