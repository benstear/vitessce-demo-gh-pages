...
import { makeStyles, Grid, Paper, Typography, Slider, Button, NativeSelect, Checkbox, MenuItem, Add as AddIcon, Visibility as VisibilityIcon, VisibilityOff as VisibilityOffIcon, Image as ImageIcon, ExpandMore, ExpandLess, MoreVert as MoreVertIcon, } from '@vitessce/styles';
...
export default function ImageLayerController(props) {
    ...
    return (_jsx(Grid, { className: controllerSectionClasses.layerControllerGrid, children: _jsxs(Paper, { elevation: 4, className: controllerSectionClasses.layerControllerRoot, children: [_jsxs(Grid, { container: true, direction: "row", justifyContent: "space-between", children: [_jsx(Grid, { size: 1, children: _jsx(Button, { className: menuClasses.imageLayerVisibleButton, onClick: handleVisibleChange, "aria-label": "Toggle layer visibility", children: _jsx(Visibility, {}) }) }), _jsx(Grid, { size: 1 }), _jsx(Grid, { size: 6, children: _jsx(Typography, { className: menuClasses.imageLayerName, children: label }) }), _jsx(Grid, { size: 2, children: _jsx(Slider, { value: opacity, min: 0, max: 1, step: 0.001, onChange: handleOpacityChange, className: menuClasses.imageLayerOpacitySlider, orientation: "horizontal", "aria-label": `Adjust opacity for layer ${label}` }) }), _jsx(Grid, { size: 1, children: _jsx(ImageLayerEllipsisMenu, { colormap: colormap, setColormap: setColormap, photometricInterpretation: photometricInterpretation, setPhotometricInterpretation: setPhotometricInterpretation, spatialTargetResolution: spatialTargetResolution, setSpatialTargetResolution: setSpatialTargetResolution, volumetricRenderingAlgorithm: volumetricRenderingAlgorithm, setVolumetricRenderingAlgorithm: setVolumetricRenderingAlgorithm, spatialLayerTransparentColor: spatialLayerTransparentColor, setSpatialLayerTransparentColor: setSpatialLayerTransparentColor, spatialRenderingMode: spatialRenderingMode, image: image, channelScopes: channelScopes, tooltipsVisible: tooltipsVisible, setTooltipsVisible: setTooltipsVisible, channelLabelsVisible: channelLabelsVisible, setChannelLabelsVisible: setChannelLabelsVisible, channelLabelsOrientation: channelLabelsOrientation, setChannelLabelsOrientation: setChannelLabelsOrientation, channelLabelSize: channelLabelSize, setChannelLabelSize: setChannelLabelSize }) }), _jsxs(Grid, { size: 1, container: true, direction: "row", children: [_jsx(ImageIcon, { className: classes.layerTypeImageIcon }), isMultiChannel ? (_jsx(Button, { onClick: handleOpenChange, className: classes.channelExpansionButton, "aria-label": "Expand or collapse channel controls", children: open ? _jsx(ExpandLess, {}) : _jsx(ExpandMore, {}) })) : null] })] }), isMultiChannel && open ? (_jsxs(Grid, { container: true, direction: "column", justifyContent: "space-between", className: classes.imageChannelControllerGrid, children: [channelScopes.map((cScope) => {
                            ...
                            return (_jsx(ImageChannelController, { theme: theme, coordinationScopesRaw: coordinationScopesRaw, layerScope: layerScope, channelScope: cScope, targetT: targetT, targetZ: targetZ, targetC: channelIndex, setTargetC: setSpatialTargetC, visible: spatialChannelVisible, setVisible: setSpatialChannelVisible, opacity: spatialChannelOpacity, setOpacity: setSpatialChannelOpacity, color: spatialChannelColor, setColor: setSpatialChannelColor, window: spatialChannelWindow, setWindow: setSpatialChannelWindow, colormapOn: colormap !== null, featureIndex: featureIndex, image: image, spatialRenderingMode: spatialRenderingMode }, cScope));
                        }), _jsx(Button, { disabled: (channelScopes.length === viv.MAX_CHANNELS
                                || channelScopes.length === imageNumChannels), onClick: handleChannelAdd, fullWidth: true, variant: "outlined", className: classes.imageLayerButton, startIcon: _jsx(AddIcon, {}), size: "small", "aria-label": "Add a channel to this layer", children: "Add Channel" })] })) : null, is3dMode && image ? (_jsxs(Grid, { container: true, direction: "column", justifyContent: "space-between", className: classes.imageChannelControllerGrid, children: [_jsx(Typography, { className: classes.clippingPanesLabel, children: "Clipping planes:" }), _jsx(Grid, { size: 12, className: classes.clippingSliders, children: _jsx(ClippingSliders, { image: image, spatialSliceX: spatialSliceX, spatialSliceY: spatialSliceY, spatialSliceZ: spatialSliceZ, setSpatialSliceX: setSpatialSliceX, setSpatialSliceY: setSpatialSliceY, setSpatialSliceZ: setSpatialSliceZ }) })] })) : null] }) }));
}
