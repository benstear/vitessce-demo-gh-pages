...
const Heatmap = forwardRef((props, deckRef) => {
    ...
    return (_jsx(deck.DeckGL, { id: `deckgl-overlay-${uuid}`, ref: deckRef, onWebGLInitialized: setGlContext, views: [
            ...
            ...cellColorsViews,
        ], layers: layers, layerFilter: layerFilter, getCursor: interactionState => (interactionState.isDragging ? 'grabbing' : cursorType), glOptions: DEFAULT_GL_OPTIONS, onViewStateChange: onViewStateChange, viewState: viewState, onHover: onHover, useDevicePixels: useDevicePixels, onClick: onHeatmapClick, width: "100%", height: "100%" }));
});
