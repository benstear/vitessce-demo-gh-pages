...
export default class ObsSetStatsAnndataLoader extends AbstractTwoStepLoader {
    ...
    async loadDataFrame(dfPath) {
        const [obsSetId, obsSetFoldChange, interceptExpectedSample, effectExpectedSample, isCredibleEffect,
    ...
    async loadMulti(volcanoOptions) {
        ...
        const rawObsSetGroups = Array.from(new Set(rawObsSetSelection.map(setPath => setPath?.[0])));
