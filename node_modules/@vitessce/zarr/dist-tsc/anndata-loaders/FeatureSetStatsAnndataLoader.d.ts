...
export default class FeatureStatsAnndataLoader<DataSourceType extends AnnDataSource> extends AbstractTwoStepLoader<DataSourceType> {
    ...
    loadFeatureSetNames(dfPath: any): Promise<string[]>;
    loadFeatureSetTerms(dfPath: any): Promise<string[]>;
    loadDataFrame(dfPath: any): Promise<{
        featureSetName: any[];
        featureSetTerm: any[];
        featureSetSignificance: any;
    }>;
    /**
     *
...
//# sourceMappingURL=FeatureSetStatsAnndataLoader.d.ts.map