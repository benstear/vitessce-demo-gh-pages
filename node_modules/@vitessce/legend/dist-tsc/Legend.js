    ...
    useEffect(() => {
        ...
        if (!considerSelections || obsColorEncoding === 'geneSelection') {
            ...
            if (featureValueColormap && pointsVisible) {
                ...
                if ((contourPercentages?.[1] - contourPercentages?.[0] <= NEIGHBOR_THRESHOLD)
        ...
        const featureSelectionLabelRaw = (featureSelection
            && featureSelection.length >= 1
            && !isStaticColor)
