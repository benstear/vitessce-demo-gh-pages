...
export function GenomicProfilesSubscriber(props) {
    const { coordinationScopes, theme, closeButtonVisible, downloadButtonVisible, removeGridComponent, profileTrackUidKey = 'path', profileTrackNameKey = null, higlassServer = 'https://higlass.io/api/v1', assembly = 'hg38', title = 'Genomic Profiles', showGeneAnnotations = true, helpText = ViewHelpMapping.GENOMIC_PROFILES, } = props;
