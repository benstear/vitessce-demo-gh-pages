...
export function HiGlassSubscriber(props) {
    ...
    return (_jsx("div", { className: classes.higlassTitleWrapper, children: _jsx(TitleInfo, { title: "HiGlass", closeButtonVisible: closeButtonVisible, downloadButtonVisible: downloadButtonVisible, removeGridComponent: removeGridComponent, theme: theme, isReady: true, urls: urls, children: _jsxs("div", { className: classes.higlassLazyWrapper, ref: containerRef, children: [_jsx(HiglassGlobalStyles, { classes: classes }), _jsx(HiGlassLazy, { coordinationScopes: coordinationScopes, theme: higlassTheme, hgViewConfig: hgViewConfig, height: height })] }) }) }));
}
