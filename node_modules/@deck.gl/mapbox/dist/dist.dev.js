...
/*!***************************!*\
  !*** ./src/deck-utils.ts ***!
  \***************************/
/*! exports provided: getDeckInstance, getInterleavedProps, addLayer, removeLayer, updateLayer, drawLayer, getViewState */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getDeckInstance", function() { return getDeckInstance; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getInterleavedProps", function() { return getInterleavedProps; });
...
function getDeckInstance({
  ...
  const deckProps = getInterleavedProps({ ...deck?.props,
    _customRender: () => {
...
function getInterleavedProps(currProps) {
  ...
  const nextProps = { ...currProps,
    ...
    parameters: {
      ...
      depthFunc: _luma_gl_constants__WEBPACK_IMPORTED_MODULE_1__["default"].LEQUAL,
...
class MapboxOverlay {
  ...
  setProps(props) {
    ...
    if (this._deck) {
      this._deck.setProps(this._interleaved ? Object(_deck_utils__WEBPACK_IMPORTED_MODULE_1__["getInterleavedProps"])(this._props) : this._props);
    }
  }
  ...
  _onAddInterleaved(map) {
    this._deck = Object(_deck_utils__WEBPACK_IMPORTED_MODULE_1__["getDeckInstance"])({
      map,
      // @ts-ignore non-public map property
      gl: map.painter.context.gl,
      deck: new _deck_gl_core__WEBPACK_IMPORTED_MODULE_0__["Deck"]({ ...this._props,
        // @ts-ignore non-public map property
        gl: map.painter.context.gl
      })
    });
