...
var aI = (r, Q, a) => Q in r ? GI(r, Q, { enumerable: !0, configurable: !0, writable: !0, value: a }) : r[Q] = a;
var M = (r, Q, a) => aI(r, typeof Q != "symbol" ? Q + "" : Q, a);
import { _ as wI } from "./chunk-INHXZS53-DiyuLb3Z.js";
var NI = (typeof document < "u" && document.currentScript && document.currentScript.src, function(r = {}) {
  ...
  var t = 0, O = null;
  function v(A) {
    throw Q.onAbort?.(A), A = "Aborted(" + A + ")", T(A), QA = !0, A = new WebAssembly.RuntimeError(A + ". Build with -sASSERTIONS for more info."), S(A), A;
  }
  ...
  function xA(A, I) {
    var g = m;
    return b || typeof WebAssembly.instantiateStreaming != "function" || GA(g) || fA(g) || typeof fetch != "function" ? wA(g, A, I) : fetch(g, { credentials: "same-origin" }).then((B) => WebAssembly.instantiateStreaming(B, A).then(I, function(C) {
      return T(`wasm streaming compile failed: ${C}`), T("falling back to ArrayBuffer instantiation"), wA(g, A, I);
    }));
  }
  var u = (A) => {
    for (; 0 < A.length; )
  ...
  var NA = 0, SA, k = (A) => {
    ...
    var C = Array(A.length), i = [], D = 0;
    A.forEach((o, E) => {
      W.hasOwnProperty(o) ? C[E] = W[o] : (i.push(o), Z.hasOwnProperty(o) || (Z[o] = []), Z[o].push(() => {
        C[E] = W[o], ++D, D === i.length && g(C);
      }));
    }), i.length === 0 && g(C);
  };
  function bA(A, I, g = {}) {
    ...
    W[A] = I, delete X[A], Z.hasOwnProperty(A) && (I = Z[A], delete Z[A], I.forEach((C) => C()));
  }
  function Y(A, I, g = {}) {
  ...
  var zA = (A, I) => {
    ...
    function g(i) {
      C[i] || W[i] || (X[i] ? X[i].forEach(g) : (B.push(i), C[i] = !0));
    }
    var B = [], C = {};
  ...
  for (var KA = typeof TextDecoder < "u" ? new TextDecoder("utf8") : void 0, MA = (A, I, g) => {
    ...
    for (B = ""; I < g; ) {
      ...
      if (C & 128) {
        var i = A[I++] & 63;
        if ((C & 224) == 192)
          B += String.fromCharCode((C & 31) << 6 | i);
        else {
          var D = A[I++] & 63;
          C = (C & 240) == 224 ? (C & 15) << 12 | i << 6 | D : (C & 7) << 18 | i << 12 | D << 6 | A[I++] & 63, 65536 > C ? B += String.fromCharCode(C) : (C -= 65536, B += String.fromCharCode(55296 | C >> 10, 56320 | C & 1023));
        }
      } else
    ...
    for (var g = 0, B = ""; !(g >= I / 4); ) {
      ...
      if (C == 0)
        break;
      ++g, 65536 <= C ? (C -= 65536, B += String.fromCharCode(55296 | C >> 10, 56320 | C & 1023)) : B += String.fromCharCode(C);
    }
    return B;
  }, iI = (A, I, g) => {
  ...
  } }), L.F.push({ value: void 0 }, { value: null }, { value: !0 }, { value: !1 }), L.H = L.F.length, Q.count_emval_handles = () => {
...
` + B.replace(/^Error(:[^\n]*)?\n/, ""));
  ...
  var yI = {
    ...
    l: (A, I, g, B) => {
      I = k(I), Y(A, { name: I, fromWireType: function(C) {
        return !!C;
    ...
    i: (A, I, g) => {
      I = k(I), Y(A, { name: I, fromWireType: (B) => B, toWireType: (B, C) => C, argPackAdvance: 8, readValueFromPointer: lA(I, g), G: null });
    },
    d: (A, I, g, B, C, i, D) => {
      var o = vA(I, g);
      A = k(A), A = AI(A), C = $A(B, C), eA(A, function() {
        ...
        var s = E[1] !== null && !1, d = LA(E), rA = E[0].name !== "void";
        N = [VA, N, i, jA, E[0], E[1]];
        for (var U = 0; U < F - 2; ++U)
          N.push(E[U + 2]);
        if (!d)
...
`];
    ...
    b: (A, I, g, B, C) => {
      if (I = k(I), C === -1 && (C = 4294967295), C = (o) => o, B === 0) {
        var i = 32 - 8 * g;
        C = (o) => o << i >>> i;
      }
    ...
    a: (A, I, g) => {
      function B(i) {
        return new C(P.buffer, w[i + 4 >> 2], w[i >> 2]);
      }
      var C = [Int8Array, Uint8Array, Int16Array, Uint16Array, Int32Array, Uint32Array, Float32Array, Float64Array][I];
      g = k(g), Y(A, { name: g, fromWireType: B, argPackAdvance: 8, readValueFromPointer: B }, { P: !0 });
    },
    e: (A, I) => {
      I = k(I);
      var g = I === "std::string";
      Y(A, { name: I, fromWireType: function(B) {
        ...
        var i, D = typeof C == "string";
        if (!(D || C instanceof Uint8Array || C instanceof Uint8ClampedArray || C instanceof Int8Array))
          throw new R("Cannot pass non-string to std::string");
        var o;
        if (g && D)
          for (i = o = 0; i < C.length; ++i) {
        ...
        if (i = o, o = BA(4 + i + 1), E = o + 4, w[o >> 2] = i, g && D) {
          if (D = E, E = i + 1, i = h, 0 < E) {
            ...
            for (var y = 0; y < C.length; ++y) {
              var G = C.charCodeAt(y);
              if (55296 <= G && 57343 >= G) {
                var N = C.charCodeAt(++y);
    ...
    c: (A, I, g) => {
      if (g = k(g), I === 2)
        var B = BI, C = CI, i = QI, D = () => j, o = 1;
      else
        I === 4 && (B = EI, C = iI, i = DI, D = () => w, o = 2);
      Y(A, { name: g, fromWireType: (E) => {
        ...
        return w[N >> 2] = G >> o, C(y, N + 4, G + I), E !== null && E.push(c, N), N;
      }, argPackAdvance: 8, readValueFromPointer: UA, G(E) {
        c(E);
      } });
    },
    m: (A, I) => {
      I = k(I), Y(A, { R: !0, name: I, argPackAdvance: 0, fromWireType: () => {
      }, toWireType: () => {
      } });
    },
    g: RA,
    ...
    q: (A) => {
      ...
      for (var g = 1; 4 >= g; g *= 2) {
        ...
        B = Math.max(A, B);
        A: {
          C = (C.min.call(C, 2147483648, B + (65536 - B % 65536) % 65536) - l.buffer.byteLength + 65535) / 65536;
          try {
            l.grow(C), DA();
            var i = 1;
            break A;
    ...
    t: (A, I) => {
      var g = 0;
      return YA().forEach((B, C) => {
        var i = I + g;
        for (C = w[A + 4 * C >> 2] = i, i = 0; i < B.length; ++i)
          P[C++ >> 0] = B.charCodeAt(i);
        P[C >> 0] = 0, g += B.length + 1;
      }), 0;
    },
    u: (A, I) => {
      var g = YA();
      w[A >> 2] = g.length;
      var B = 0;
      return g.forEach((C) => B += C.length + 1), w[I >> 2] = B, 0;
    },
    s: () => 52,
    n: function() {
      return 70;
    ...
    function A(g) {
      return H = g.exports, l = H.w, DA(), AA = H.A, yA.unshift(H.x), t--, Q.monitorRunDependencies?.(t), t == 0 && O && (g = O, O = null, g()), H;
    }
    var I = { a: yI };
    if (t++, Q.monitorRunDependencies?.(t), Q.instantiateWasm)
      try {
  ...
  Q.dynCall_jiji = (A, I, g, B, C) => (Q.dynCall_jiji = H.D)(A, I, g, B, C);
  var e;
  O = function A() {
    e || dA(), e || (O = A);
  };
...
}, M(J, "codecId", "blosc"), M(J, "COMPRESSORS", [...TA]), M(J, "NOSHUFFLE", 0), M(J, "SHUFFLE", 1), M(J, "BITSHUFFLE", 2), M(J, "AUTOSHUFFLE", -1), J), LI = RI;
export {
  LI as default
};
